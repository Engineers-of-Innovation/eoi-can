...
# check if valid ip address is provided
...
scp target/armv7-unknown-linux-gnueabihf/release/eoi-can-display-framebuffer root@${1}:~
scp target/armv7-unknown-linux-gnueabihf/release/eoi-gnss-to-can root@${1}:~